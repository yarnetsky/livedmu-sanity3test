...
var MediaLibrary = function (_a) {
    var _b = _a.assets, assets = _b === void 0 ? [] : _b, handleSelect = _a.handleSelect, isAssetSource = _a.isAssetSource, loading = _a.loading, onClose = _a.onClose, onDelete = _a.onDelete, onEdit = _a.onEdit, onSortChange = _a.onSortChange, selectedAssets = _a.selectedAssets, setIsDraggingMediaItem = _a.setIsDraggingMediaItem, setSearchQuery = _a.setSearchQuery, setSelectedAssets = _a.setSelectedAssets;
    ...
    return (react_1.default.createElement(StyledContainer, null,
        react_1.default.createElement(TopBar_1.TopBar, { onSortChange: onSortChange, setSearchQuery: setSearchQuery, setViewType: setViewType, viewType: viewType }),
